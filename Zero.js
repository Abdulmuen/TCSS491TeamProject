...
//===============================================Start=======================================================================================================================//
    update() {
        if(!this.isDead){//if not dead
            ...
            if(this.game.keys["x"] && params.canSlow){//slow motion
            ...
            if(!this.isJumping && !this.isfalling && !this.isDying){//ground physics
                ...
                }else if(this.game.keys["e"]){//for attacks
                    this.animator = this.attack1[this.facing];
                }else if(this.game.keys["f"]){//slide 
            ...
            }else if(this.isJumping || this.isfalling) {//continue jump routine
                if(this.q){
                    this.jumping(TICK, 50, this.facing, this.rolejump);
                }else
                    this.jumping(TICK, 50, this.facing, this.jump);
...
//===============================================End=======================================================================================================================//
    ...
    jumping(TICK, s, facing, animator) {
        if(this.isJumping && (this.game.up || this.game.keys["q"]) ){
